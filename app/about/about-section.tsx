...
const nextjsSVG = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" width="58">
      <mask
        height="180"
        id=":r8:mask0_408_134"
...
const mercadopagoSVG = () => {
  return (
    <svg id="logos" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1048.82 425.2">
      ...
      <path
        className="cls-3"
        d="m274.38,116.94c-77.83,0-140.91,40.36-140.91,90.15s63.09,94.05,140.91,94.05,140.91-44.27,140.91-94.05-63.09-90.15-140.91-90.15Z"
      />
      <path
        className="cls-2"
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium">{t('about.mission.features.performance.title')}</h4>
                  <p className="text-sm text-muted-foreground">
                    {t('about.mission.features.performance.description')}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium">{t('about.mission.features.security.title')}</h4>
                  <p className="text-sm text-muted-foreground">
          ...
          <div className="relative">
            <div className="aspect-square rounded-lg overflow-hidden border-2 border-primary/10 shadow-xl relative">
              <Image
                src="/images/logos/mainLogo.png"
                alt="Marketplace de Autos"
                fill
        ...
        <div className="space-y-8">
          <h3 className="text-2xl font-bold text-center">{t('about.tech.title')}</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              <Card key={index} className="border-none bg-background/50 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  <div className="relative h-12 w-full mb-4 mx-auto flex justify-center">
                    {tech.icon}
                    </div>
